/// Parser utilities used by LuaLike's format, binary, string, and pattern
/// implementations.
///
/// Import this library when you want the reusable parser implementations behind
/// features such as `string.format`, `string.pack`, or Lua pattern handling,
/// but do not need the full runtime bridge from `package:lualike/lualike.dart`.
///
