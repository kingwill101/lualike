...
@immutable
sealed class LualikeIrInstruction {
  const LualikeIrInstruction(this.opcode);

  final LualikeIrOpcode opcode;
...
class ABCInstruction extends LualikeIrInstruction {
...
class ABxInstruction extends LualikeIrInstruction {
...
class AsBxInstruction extends LualikeIrInstruction {
...
class AxInstruction extends LualikeIrInstruction {
  const AxInstruction({required LualikeIrOpcode opcode, required this.ax})
    : super(opcode);
...
class AsJInstruction extends LualikeIrInstruction {
  const AsJInstruction({required LualikeIrOpcode opcode, required this.sJ})
    : super(opcode);
...
class AvBCInstruction extends LualikeIrInstruction {
