...
| Coroutines and yield / resume behavior | Missing | The AST/runtime coroutine work is complete, but the `lua_bytecode` runtime still does not execute coroutine/yield bytecode paths. | Runtime / roadmap audit |
