-- Enhanced Logging Library Demo
-- Demonstrates all features of the contextual logging system
...
logging.info("This won't show", {category = "App"})
logging.info("Login attempt detected", {category = "Security", user = "admin"})
logging.info("This also won't show", {category = "Database"})
...
logging.debug("This debug won't show")
