...
Future<void> main(List<String> arguments) async {
  final iterations = arguments.isNotEmpty ? int.parse(arguments[0]) : 100000;
  ...
  for (var trial = 0; trial < trialCount; trial++) {
    ...
    final result = await lua.execute('''
      ...
      for i = 1, $iterations do
        checksum = checksum + math.abs(-(i % 97))
      end
      return checksum
    ''');
    stopwatch.stop();
  ...
  print(
    jsonEncode(<String, Object?>{
      'schemaVersion': 1,
      'inlineBuiltinFrame': const bool.fromEnvironment(
        'LUALIKE_AST_INLINE_BUILTIN_FRAME',
        defaultValue: true,
      ),
      'inlineBuiltinFastArity': const bool.fromEnvironment(
