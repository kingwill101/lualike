...
void main() {
  group('executeCode IR mode', () {
    test('returns numeric literal', () async {
      final result = await executeCode('return 99', mode: EngineMode.ir);
    ...
    test('coerces string numbers via NumberUtils', () async {
      final result = await executeCode('return "8" / "2"', mode: EngineMode.ir);
      expect(result, equals(4));
    });

    test('evaluates modulo, floor division, and exponent', () async {
      final results = await Future.wait([
        executeCode('return 9 % 4', mode: EngineMode.ir),
        executeCode('return 9 // 4', mode: EngineMode.ir),
        executeCode('return "2" ^ 5', mode: EngineMode.ir),
      ]);
    ...
    test('evaluates comparisons against literals', () async {
      final results = await Future.wait([
        ...
        executeCode('return 5 < 10', mode: EngineMode.ir),
        executeCode('return 7 >= 7', mode: EngineMode.ir),
      ]);
