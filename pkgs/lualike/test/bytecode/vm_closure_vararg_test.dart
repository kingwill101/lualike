...
void main() {
  group('BytecodeVm closures and varargs', () {
...
''';
    ...
    test('returns all varargs from bytecode function', () async {
      final chunk = BytecodeCompiler().compile(
...
''';
    ...
    test('installs bytecode-defined method and updates table', () async {
      const source = '''
