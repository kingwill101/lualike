...
void main() {
  ...
  group('Lualike IR lowered arithmetic', () {
    ...
    test('coerces string operands via NumberUtils', () async {
      expect(
        await executeCode('return "2" + 3', mode: EngineMode.ir),
        equals(5),
      );
      expect(
        await executeCode('return "6" / "2"', mode: EngineMode.ir),
        equals(3),
      );
    });
    ...
    test('executes modulo, floor division, and exponent', () async {
      ...
      expect(
        await executeCode('return 7 // 3', mode: EngineMode.ir),
        equals(2),
      );
    ...
    test('coerces string operands for modulo', () async {
      expect(
        await executeCode('return "9" % "4"', mode: EngineMode.ir),
        equals(1),
      );
    });
    ...
    test('executes unary operators', () async {
      expect(
        await executeCode('return not false', mode: EngineMode.ir),
        isTrue,
      );
      ...
      expect(
        await executeCode('return #"hello"', mode: EngineMode.ir),
        equals(5),
      );
    });
