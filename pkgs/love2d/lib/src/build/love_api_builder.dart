...
class LoveApiBuilder implements Builder {
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    final modules =
        (json['modules'] as List<Object?>).cast<Map<String, Object?>>();
    final symbols =
        (json['symbols'] as List<Object?>).cast<Map<String, Object?>>();
    final types =
        (json['types'] as List<Object?>).cast<Map<String, Object?>>();
    final enums =
        (json['enums'] as List<Object?>).cast<Map<String, Object?>>();
    ...
    await buildStep.writeAsString(
      refId,
      _generateReference(
          version, sourceCommit, modules, symbols, types, enums),
    );
  ...
  String _generateReference(
    ...
    buf.writeln(
        'const String loveApiVersion = ${jsonEncode(version)};');
    buf.writeln(
    ...
    // Modules
    buf.writeln(
        'const List<LoveModuleDoc> loveApiModules = <LoveModuleDoc>[');
    ...
    for (final s in symbols) {
      ...
      final variants =
          (s['variants'] as List<Object?>).cast<Map<String, Object?>>();
      buf.writeln(
          '    variants: <LoveApiVariantDoc>[');
      for (final v in variants) {
        buf.writeln('      LoveApiVariantDoc(');
        final args =
            (v['arguments'] as List<Object?>).cast<Map<String, Object?>>();
        ...
        buf.writeln('        ],');
        final rets =
            (v['returns'] as List<Object?>).cast<Map<String, Object?>>();
    ...
    for (final t in types) {
      ...
      final supertypes =
          (t['supertypes'] as List<Object?>).cast<String>();
      ...
      buf.writeln('    ],');
      final methodSymbols =
          (t['methodSymbols'] as List<Object?>).cast<String>();
    ...
    for (final e in enums) {
      ...
      final constants =
          (e['constants'] as List<Object?>).cast<Map<String, Object?>>();
  ...
  String _generateStubs(List<Map<String, Object?>> symbols) {
    ...
    for (final s in symbols) {
      ...
      buf.writeln(
          'Object? $funcName(List<Object?> args) =>');
  ...
  String _variantSignature(String symbol, Map<String, Object?> variant) {
    final args =
        (variant['arguments'] as List<Object?>).cast<Map<String, Object?>>();
    final rets =
        (variant['returns'] as List<Object?>).cast<Map<String, Object?>>();
