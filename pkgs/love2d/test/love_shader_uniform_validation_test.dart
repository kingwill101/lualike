...
''',
        ...
        await luaCallMethod(shader!, 'send', <Object?>['enabled', true]);
...
''',
        ...
        expect(
          () => luaCallMethod(shaderObject, 'send', <Object?>['center', 4.0]),
          throwsA(
            isA<LuaError>().having(
              (error) => error.message,
              'message',
        ...
        expect(
          () => luaCallMethod(shaderObject, 'send', <Object?>['enabled', 1]),
          throwsA(
            isA<LuaError>().having(
              (error) => error.message,
              'message',
        ...
        expect(
          () => luaCallMethod(shaderObject, 'send', <Object?>['mask', 1]),
          throwsA(
            isA<LuaError>().having(
              (error) => error.message,
              'message',
