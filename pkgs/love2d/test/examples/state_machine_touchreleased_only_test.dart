...
void main() {
  test('state machine touchreleased alone under bytecode', () async {
...
loaded()
''', scriptPath: '=[state machine touchreleased only bootstrap]');
...
testbed = received
''', scriptPath: '=[state machine touchreleased only inspect]');
