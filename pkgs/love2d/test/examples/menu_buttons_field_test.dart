...
void main() {
  test('menu buttons field values under bytecode', () async {
...
loaded()
''', scriptPath: '=[menu buttons field bootstrap]');
    await runtime.callLoadIfDefined();
    await runtime.execute('''
local menu = require("src.states.menu")
testbed = { count = #menu.buttons }
for i, btn in ipairs(menu.buttons) do
  testbed['y' .. i] = btn.y
  testbed['text' .. i] = btn.text
end
''', scriptPath: '=[menu buttons field inspect]');
