...
void main() {
  test('state machine touchpressed noop then touchreleased under bytecode', () async {
...
loaded()
''', scriptPath: '=[state machine touchpressed noop bootstrap]');
...
testbed = received
''', scriptPath: '=[state machine touchpressed noop inspect]');
