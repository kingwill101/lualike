...
void main() {
  ...
  test(
    'LoveFlameHarnessGame preserves transformed canvas snapshot radial shader output',
    () async {
      ...
      final sourceCanvas = LoveCanvas(
        source: 'transformed-canvas-shader-source',
        width: 4,
        height: 4,
        dpiScale: 1.0,
        readable: true,
      ...
      graphics.addCommand(
        LoveImageCommand(
          ...
          drawTransform: vm.Matrix4.translationValues(4, 0, 0),
          image: sourceCanvas.snapshot(),
        ),
      );
