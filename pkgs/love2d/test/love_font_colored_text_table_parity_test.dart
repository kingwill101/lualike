  ...
  group('love.font colored text table parity', () {
    test(
      ...
      () async {
        ...
        expect(
          await _callMethod(font, 'getWrap', <Object?>[sparseColoredText, 100.0]),
          await _callMethod(font, 'getWrap', const <Object?>['A', 100.0]),
        );
      },
    );
    ...
    test(
      ...
      () async {
        ...
        expect(
          await _callMethod(font, 'getWrap', <Object?>[missingFirstIndex, 100.0]),
          await _callMethod(font, 'getWrap', const <Object?>['', 100.0]),
        );
      },
    );
    ...
    test('Font:getWidth rejects colored text tables like LOVE', () async {
      ...
      await expectLater(
        () => _callMethod(font, 'getWidth', <Object?>[
          <Object?, Object?>{
            1: <Object?, Object?>{1: 1.0, 2: 0.25, 3: 0.5, 4: 1.0},
            2: 'A',
          },
