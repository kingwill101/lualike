...
void main() {
  group('love.font true type glyph count', () {
    test('source-backed true type rasterizers expose maxp glyph count', () async {
      ...
      final autoRasterizer = await _call(
        runtime,
        const ['love', 'font', 'newRasterizer'],
        <Object?>[fileData],
      );
      expect(await _callMethod(autoRasterizer, 'getGlyphCount'), 268);
    });
  });
}
