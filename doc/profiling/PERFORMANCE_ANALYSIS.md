...
Median p95 update time is the Lualike gate. End-to-end CPU-frame p95 remains
render-dominated and is reported separately by the benchmark.
...
the active-hook path. It improves median p95 update time by 10% without changing
the game state.
